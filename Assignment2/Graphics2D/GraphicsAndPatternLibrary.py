'''
filename: GraphicsAndPatternLibrary
Created on Oct 15, 2014

@author: pramesh bhnadari
description: this module contains the folowing functions:
            1) Function circle
            2)Function rectangle
            3)Function polygon
            4)Function chessboard
            5)spiral function of my choice
